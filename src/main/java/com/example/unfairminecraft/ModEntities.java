...
public final class ModEntities {
    ...
    public static final RegistryObject<EntityType<MilkProjectileEntity>> MILK_PROJECTILE = ENTITY_TYPES.register(
        "milk_projectile",
        () -> EntityType.Builder.<MilkProjectileEntity>of(MilkProjectileEntity::new, MobCategory.MISC)
            .sized(0.25F, 0.25F)
            .clientTrackingRange(8)
            .updateInterval(1)
            .build(UnfairMinecraftMod.MOD_ID + ":milk_projectile")
    );
    ...
    public static final class ClientEvents {
        ...
        public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
            ...
            event.registerEntityRenderer(MILK_PROJECTILE.get(), net.minecraft.client.renderer.entity.ThrownItemRenderer::new);
